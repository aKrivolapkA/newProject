...
public class DepositAccount7<T,S> extends Account6<T>{ // класс наследний может добавлять свои поля
    private  S sum;
    ...
    public static void main(String[] args) {
        ...
        DepositAccount7<String,Integer> depositAccount1 = new DepositAccount7<>("19",566);
